...
<head>
  ...
  <style>
    ...
    .fade-in-2 { animation-delay: 0.7s; }
    ...
    @media (max-width: 600px) {
      .desc { padding: 18px 8px 14px 8px; max-width: 98vw; }
      .logo { width: 70px; height: 70px; font-size: 2.1rem; }
...
<body>
  <div class="center-wrap">
    ...
    <div class="service-name fade-in fade-in-2">세무인사이드</div>
    <div class="desc fade-in fade-in-3">
      ...
      <ul style="list-style:none; padding:0; margin:0 0 18px 0; font-size:1.08rem; text-align:left; display:inline-block;">
        ...
        <li style="margin-bottom:8px; white-space:nowrap; overflow-wrap:normal;"><span style="color:#219653;font-size:1.2rem;vertical-align:-2px;">&#x2705;</span> "성장은 반복 속에서, 실력은 확인 속에서 만들어집니다."</li>
